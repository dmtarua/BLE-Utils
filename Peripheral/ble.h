...
/*static uint8_t char3_uuid[16]    = { 0x71,0x3d,0x00,0x03,0x51,0x3e,0x4c,0x75,0xba,0x94,0x31,0x48,0xf1,0x8d,0x94,0x1e };
static uint8_t char4_uuid[16]    = { 0x71,0x3d,0x00,0x04,0x51,0x3e,0x4c,0x75,0xba,0x94,0x31,0x48,0xf1,0x8d,0x94,0x1e };
static uint8_t char5_uuid[16]    = { 0x71,0x3d,0x00,0x05,0x51,0x3e,0x4c,0x75,0xba,0x94,0x31,0x48,0xf1,0x8d,0x94,0x1e };
static uint8_t char6_uuid[16]    = { 0x71,0x3d,0x00,0x06,0x51,0x3e,0x4c,0x75,0xba,0x94,0x31,0x48,0xf1,0x8d,0x94,0x1e };
static uint8_t char7_uuid[16]    = { 0x71,0x3d,0x00,0x07,0x51,0x3e,0x4c,0x75,0xba,0x94,0x31,0x48,0xf1,0x8d,0x94,0x1e };
static uint8_t char8_uuid[16]    = { 0x71,0x3d,0x00,0x08,0x51,0x3e,0x4c,0x75,0xba,0x94,0x31,0x48,0xf1,0x8d,0x94,0x1e };
static uint8_t char9_uuid[16]    = { 0x71,0x3d,0x00,0x09,0x51,0x3e,0x4c,0x75,0xba,0x94,0x31,0x48,0xf1,0x8d,0x94,0x1e };
static uint8_t char10_uuid[16]    = { 0x71,0x3d,0x00,0x0a,0x51,0x3e,0x4c,0x75,0xba,0x94,0x31,0x48,0xf1,0x8d,0x94,0x1e };*/
...
static uint16_t character5_handle = 0x0000;
static uint16_t character6_handle = 0x0000;
static uint16_t character7_handle = 0x0000;
static uint16_t character8_handle = 0x0000;
static uint16_t character9_handle = 0x0000;
static uint16_t character10_handle = 0x0000;*/
...
/*static uint8_t characteristic3_data[CHARACTERISTIC2_MAX_LEN] = { 0x01 };
static uint8_t characteristic4_data[CHARACTERISTIC2_MAX_LEN] = { 0x01 };
static uint8_t characteristic5_data[CHARACTERISTIC2_MAX_LEN] = { 0x01 };
static uint8_t characteristic6_data[CHARACTERISTIC2_MAX_LEN] = { 0x01 };
static uint8_t characteristic7_data[CHARACTERISTIC2_MAX_LEN] = { 0x01 };
static uint8_t characteristic8_data[CHARACTERISTIC2_MAX_LEN] = { 0x01 };
static uint8_t characteristic9_data[CHARACTERISTIC2_MAX_LEN] = { 0x01 };
static uint8_t characteristic10_data[CHARACTERISTIC2_MAX_LEN] = { 0x01 };*/
